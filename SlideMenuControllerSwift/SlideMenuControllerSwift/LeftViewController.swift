...
class LeftViewController : UIViewController, LeftMenuProtocol {
    ...
    var menus = ["Legislators", "Bills", "Committee", "Favourite", "About"]
...
//        self.swiftViewController = UINavigationController(rootViewController: swiftViewController)
        ...
        let swiftViewController = storyboard.instantiateViewController(withIdentifier: "BillTabBar") as! BillTabBarController
        self.swiftViewController = UINavigationController(rootViewController: swiftViewController)
